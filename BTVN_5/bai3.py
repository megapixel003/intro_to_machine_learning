...
# Bước 2: Hiển thị ma trận nhầm lẫn cho k-NN và Decision Tree
print("Ma trận nhầm lẫn cho mô hình k-NN:")
ConfusionMatrixDisplay.from_estimator(knn, X_test, y_test)
plt.show()

print("Ma trận nhầm lẫn cho mô hình Decision Tree:")
ConfusionMatrixDisplay.from_estimator(decision_tree, X_test, y_test)
plt.show()

# Bước 3: Vẽ biên giới quyết định (decision boundary) cho k-NN và Decision Tree
